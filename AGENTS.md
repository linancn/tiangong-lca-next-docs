...
lastReviewedNote: "Reviewed docs-impact issue #380 public docs, screenshot evidence, and llms.txt changes; repo ownership, bilingual workflow, and publication boundary remain accurate."
related:
  - .docpact/config.yaml
