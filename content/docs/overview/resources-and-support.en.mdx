...
The platform uses [TIDAS](https://tidas.tiangong.earth/en/docs/) (**TI**angong **DA**ta **S**ystem) to organise and exchange LCA data in a shared structure, while drawing on the basic principles and framework of life cycle assessment.
...
The [TIDAS data-structure guide](https://tidas.tiangong.earth/en/docs/core-modules/schema/tidas-schema-intro/) explains its JSON structure, structure checks, and links between datasets. The TIDAS documentation defines the current specification and tool capabilities.
