...
lastReviewedNote: "Reviewed docs-impact issue #380 public docs, mirrored screenshots, and llms.txt changes; local development guidance remains aligned with the Chinese source."
related:
  - docs/dev/dev-env.md
